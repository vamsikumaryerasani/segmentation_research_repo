...
data_root = 'data/railsem19_mmseg_90_10/'
...
# NOTE: single GPU -> keep batch size reasonable to avoid OOM.
# If you hit CUDA OOM, drop samples_per_gpu to 8 / 4 / 2.
data = dict(
    samples_per_gpu=8,
    workers_per_gpu=2,
...
# -------------------------
# Early stopping on VAL LOSS (patience=5, interval=1)
...
custom_hooks = [
    dict(
        ...
        interval=1,
        num_batches=None,  # set 200 if you want faster
    ),
    dict(
