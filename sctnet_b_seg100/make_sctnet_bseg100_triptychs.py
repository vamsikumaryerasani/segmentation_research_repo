...
def find_gt_mask_by_basename(img_path, gt_dir):
    """
    GT is expected to be a PNG with the same basename as the image.
    Example:
...
def to_black_gray(mask):
    ...
    0..18 remain dark values, ignore=255 stays bright.
    """
...
def main():
    ...
    print(f"[OK] wrote {n_done} grayscale triptychs -> {out_black}")
