...
def to_black_gray(mask):
    # Keep class IDs as dark grayscale values
...
def title_prefix_from_filename(img_path):
    """
    Example:
...
def main():
    ...
    ap.add_argument("--in-dir", required=True, help="input RGB images dir")
